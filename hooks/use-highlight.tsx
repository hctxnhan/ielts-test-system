...
// import { highlightStore } from "@testComponents/store/highlight-store";
...
//       if (questionId && contentRef.current) {
//         const updatedHTML = contentRef.current.innerHTML;

//         highlightStore.getState().setHighlight(questionId, updatedHTML);
//         onQuestionHighlighted?.(questionId, updatedHTML);
...
export function useHighlightHandler(
  ...
  useEffect(() => {
    ...
    // Load saved highlight from Zustand
    // if (questionId && contentRef.current) {
    //   const content = contentRef.current.innerHTML;
    //   highlightStore.getState().setHighlight(questionId, content);
    // }
    ...
    const handleMouseUp = () => {
      ...
      if (questionId && contentRef.current) {
        const content = contentRef.current.innerHTML;
        highlightStore.getState().setHighlight(questionId, content);
        // onQuestionHighlighted?.(questionId, content);
      }
    };
