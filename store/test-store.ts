...
import { getQuestionStatus } from "@/lib/test-utils";
    ...
    (set, get) => ({
          ...
          switch (question.type) {
            ...
            case "matching-headings":
              ...
              if (answer && typeof answer === "object") {
                ...
                const correctCount = Object.entries(answer).filter(
                  ([key, value]) =>
                    question.headings[Number.parseInt(key)].correctAnswer ===
                    value
                ).length;
            ...
            case "labeling":
              ...
              if (answer && typeof answer === "object") {
                ...
                const correctCount = Object.entries(answer).filter(
                  ([key, value]) =>
                    question.labels[Number.parseInt(key)].correctAnswer ===
                    value
                ).length;
            ...
            case "pick-from-list":
              ...
              if (answer && typeof answer === "object") {
                ...
                if (scoringStrategy === "partial") {
                  // Partial credit based on number of correct answers
                  score = Math.round(
                    (correctCount / totalPicks) * question.points
                  );
      ...
      nextQuestion: () => {
        ...
        const currentSection =
          currentTest.sections[progress.currentSectionIndex];
