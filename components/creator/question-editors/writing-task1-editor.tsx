  ...
  return (
    <div className="grid gap-3">
      <div className="grid gap-1.5">
        <Label htmlFor={`prompt-${question.id}`} className="text-sm font-medium">Task Prompt</Label>
        <Textarea
      ...
      <div className="grid gap-1.5">
        <Label htmlFor={`image-url-${question.id}`} className="text-sm font-medium">Chart/Graph Image</Label>
        <FilePicker fileType="image" onFileSelect={handleImageSelect} currentFileUrl={question.imageUrl} />
      </div>

      <div className="grid grid-cols-2 gap-3">
        <div className="grid gap-1.5">
          <Label htmlFor={`word-limit-${question.id}`} className="text-sm font-medium">Word Limit</Label>
          <Input
      ...
      <div className="grid gap-1.5">
        <Label htmlFor={`scoring-prompt-${question.id}`} className="text-sm font-medium">
          AI Scoring Prompt <span className="font-normal text-muted-foreground">(Optional)</span>
        </Label>
        <Textarea
      ...
      <div className="grid gap-1.5">
        <Label htmlFor={`sample-answer-${question.id}`} className="text-sm font-medium">
          Sample Answer <span className="font-normal text-muted-foreground">(Optional)</span>
        </Label>
        <Textarea
